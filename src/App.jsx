...
const translations = {
  en: {
    ...
    about: {
      ...
      paragraph1: 'Pink Pizza began when Turkish brothers Engin and Ismail transformed a section of their Späti shop into a pizzeria. Their love for bold flavors and warm hospitality quickly won hearts in the neighborhood.',
  ...
  de: {
    ...
    about: {
      ...
      paragraph1: 'Pink Pizza entstand, als die türkischen Brüder Engin und Ismail eine Ecke ihres Spätis in eine Pizzeria verwandelten. Ihre Liebe zu kräftigen Aromen und herzlicher Gastfreundschaft gewann schnell die Herzen der Nachbarschaft.',
